...
import com.google.api.services.mirror.Mirror.Contacts.Insert;
...
public class MirrorClient {
	...
	public static APP_NAME = "Default Glass App Name"	// set from config
	public static IMAGE_URL = ""
	
	public static setConfig(def config) {
     ...
     */
    public static Subscription insertSubscription(Credential credential, String callbackUrlStr,
	...
	public static String getTimelineItem(Credential credential, String timelineItemId) {
